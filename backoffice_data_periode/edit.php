...
if (isset($_POST['edit'])){
    ...
    $keterangan = trim(mysqli_real_escape_string($con,$_POST['periode']));


        $queryedit = mysqli_query($con,"UPDATE tbl_periode SET keterangan='$keterangan' WHERE kode_periode='$kd_periode' ")or die(mysqli_error($con));
        echo '
