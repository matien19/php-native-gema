          ...
          <div class="col-lg-4">
           <?php
              if (isset($con, $_POST['updatepw'])) {
                ...
                if ($cekkarakter > 11) {
                    mysqli_query($con, "UPDATE tbl_pengguna SET kata_sandi='$pwbaru' WHERE NIP='$nip'")or die(mysqli_error($con));
                ...
                <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
                <script>
                swal("Error", "Password minimal 12 karakter", "error");
