...
<head>
  ...
  <!-- site metas -->
  <title>PPDB Sekolah Tinggi TMI</title>
  <meta name="keywords" content="">
  <meta name="description" content="">
  <meta name="author" content="">
  <!-- fevicon -->
  <link rel="icon" href="auth/assets/img/logo.png" />
  <!-- bootstrap css -->
  ...
  <link rel="stylesheet" href="assets_frontend/https://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css">
  <link rel="stylesheet" href="assets_frontend/https://cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.min.css" media="screen">
<!--[if lt IE 9]>
    ...
    <footr>
      <div class="footer ">
        <div class="container">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 ">
                  <div class="address">
                    ...
                    <ul class="loca">
                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6 ">
                        <div class="address">
                          <a href="auth" target="_blank"> <img src="assets_frontend/images/logo1.jpg" alt="logo"></a>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <script src="assets_frontend/https:cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.min.js"></script>
